	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(utente != null) {
				...
				/*sessione.setAttribute("sessione",usernameDaPagina );
		        sessione.setAttribute("nomeParam", utente.getNome());
		        sessione.setAttribute("cognomeParam",utente.getCognome());
		        sessione.setAttribute("codiceFiscaleParam", utente.getCodiceFiscale());
		        sessione.setAttribute("role", utente.getRuolo());*/
