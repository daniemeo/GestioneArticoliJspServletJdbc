...
CREATE TABLE `articolo` (
  ...
  PRIMARY KEY (`ID`),
  KEY `categoria articolo_idx` (`categoria_fk`),
  CONSTRAINT `categoria articolo` FOREIGN KEY (`categoria_fk`) REFERENCES `categoria` (`idCategoria`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `articolo` VALUES (20,'nn','tabella',2,8);
