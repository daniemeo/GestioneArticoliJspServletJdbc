...
CREATE TABLE `categoria` (
  ...
  `descrizione_categoria` varchar(45) NOT NULL,
  PRIMARY KEY (`idCategoria`),
  UNIQUE KEY `descrizione_categoria_UNIQUE` (`descrizione_categoria`)
...
INSERT INTO `categoria` VALUES (8,'casa','categoria figa '),(9,'giardinaggio','categoria giardinaggio, ');
